package com.beyond.query.result;
 ...
 * @date 2019/11/07
 */
public class SolrResultContainer implements ResultContainer<QueryResponse> {
    ...
    public SolrResultContainer() {
    }

    public SolrResultContainer(QueryResponse response) {
    ...
    public <T> Page<T> getQueryResultPage(Class<T> clazz,Pageable pageable) {
        ...
        page.setContent(getQueryResult(clazz));
