...
public class User2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2638337438320843197L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User2\",\"namespace\":\"com.beyond.avro.auto\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":[\"int\",\"null\"]},{\"name\":\"phone\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static BinaryMessageEncoder<User2> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a User2 instance decoded from the given buffer
   ...
   */
  public User2(java.lang.CharSequence name, java.lang.Integer age, java.lang.CharSequence phone) {
    this.name = name;
    this.age = age;
    this.phone = phone;
  }
   ...
   */
  public static com.beyond.avro.auto.User2.Builder newBuilder() {
    return new com.beyond.avro.auto.User2.Builder();
  }
   ...
   * @return A new User2 RecordBuilder
   */
  public static com.beyond.avro.auto.User2.Builder newBuilder(com.beyond.avro.auto.User2.Builder other) {
    if (other == null) {
      return new com.beyond.avro.auto.User2.Builder();
    } else {
      return new com.beyond.avro.auto.User2.Builder(other);
    }
  }
   ...
   * @return A new User2 RecordBuilder
   */
  public static com.beyond.avro.auto.User2.Builder newBuilder(com.beyond.avro.auto.User2 other) {
    if (other == null) {
      return new com.beyond.avro.auto.User2.Builder();
    } else {
      return new com.beyond.avro.auto.User2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.beyond.avro.auto.User2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.beyond.avro.auto.User2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.beyond.avro.auto.User2.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.beyond.avro.auto.User2.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.beyond.avro.auto.User2.Builder setAge(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.beyond.avro.auto.User2.Builder clearAge() {
      age = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.beyond.avro.auto.User2.Builder setPhone(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.beyond.avro.auto.User2.Builder clearPhone() {
      phone = null;
