...
function select(e){
	...
	$("th:nth-child(even)").animate({"left":"-110%"},1000);
	$("th:nth-child(odd)").animate({"left":"110%"},1000);
	$("tr:nth-child(even) td").not($(e).parent().children()).animate({"left":"-110%"},1000,function(){
		$(e).parent().siblings().hide(0,function(){
			$(e).parent().parent().parent().css({"margin-top":top1}).animate({"margin-top":0},1000)
		});
	});
	
	$("tr:nth-child(odd) td").not($(e).parent().children()).animate({"left":"110%"},1000,function(){
		$(e).parent().siblings().hide(200,function(){
			$(e).parent().parent().parent().css({"margin-top":top1}).animate({"margin-top":0},1000)
		});
	});
